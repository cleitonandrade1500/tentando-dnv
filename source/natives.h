...
namespace OBJECT {
    ...
    extern void DOOR_CONTROL(Hash door, float x, float y, float z, bool locked, float xRot, float yRot, float zRot);
}
namespace HUD {
    extern void SET_BLIP_SPRITE(int blip, Hash spriteHash);
    extern void SET_BLIP_COLOUR(int blip, int colour);
}
namespace MAP {
    extern int SET_BLIP_FOR_ENTITY(Entity entity);
}
