...
namespace ENTITY {
    ...
    extern void SET_ENTITY_HEALTH(Entity entity, int health, int p2);
...
namespace PED {
    ...
    extern void SET_PED_CONFIG_FLAG(Ped ped, int flag, bool value);
}
namespace TASK {
...
namespace STREAMING {
    extern void REQUEST_MODEL(Hash model, bool p1); extern bool HAS_MODEL_LOADED(Hash model);
...
namespace MISC { 
    extern Hash GET_HASH_KEY(const char* str); extern bool GET_MISSION_FLAG();
    extern int GET_RANDOM_INT_IN_RANGE(int min, int max);
